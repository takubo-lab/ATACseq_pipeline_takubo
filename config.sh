...
# =============================================================================
# Canonical peak universe used to normalize external region sets.
FGSEA_REFERENCE_BED="${DIR}/Peak_nomodel/Peaks_250bp_th0.bed"

# External accessibility region-set sources.
FGSEA_SET_SOURCES=(
    "${DIR}/Differential_Peak_Iwama"
    "${DIR}/Differential_Peak_Kobayashi"
)

FGSEA_MIN_SIZE=15         # Minimum number of overlapping peaks per set
FGSEA_MAX_SIZE=500        # Maximum number of overlapping peaks per set
FGSEA_PADJ="0.05"        # Significance cutoff for summary plots/tables
...
DIR_PLOTS="Plots"
DIR_PEAKSET_LIBRARY="PeakSetLibrary"
DIR_FGSEA="PeakSetEnrichment"
